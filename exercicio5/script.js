...
if(imc < 18,5){
     document.write(`Seu IMC é de ${imc.toFixed(2)} Você está abaixo da faixa de peso ideal`)
}else if(imc >24,99){
     document.write(`Seu IMC é de ${imc.toFixed(2)} Você está acima da faixa de peso ideal`)
     document.write("Você está acima da faixa de peso ideal")
}else{
     document.write(`Seu IMC é de ${imc.toFixed(2)} Você está dentro da faixa de peso ideal`)
}
